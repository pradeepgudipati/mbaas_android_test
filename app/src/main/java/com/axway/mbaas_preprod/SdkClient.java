 ...
 */
private Response getAPIResponse(@Nullable String path, @NonNull String method, @Nullable List<Pair> queryParams, @Nullable Object body, @NonNull Map<String, String> headerParams, @NonNull Map<String, Object> formParams, @Nullable String accept, @Nullable String contentType,
    ...
    applyAuthHeaders(authNames, headerBuilder, url, requestBuilder);
            ...
            if(Arrays.asList(authNames).contains(mForceAuthName)){
                ...
                if(mForceAuthName.equalsIgnoreCase(SdkConstants.NAME_API_AUTH)){
                    ...
                    if("query".equalsIgnoreCase(apiKeyAuth.getLocation())){
                        addQueryParameter(header, httpUrlBuilder);
                    }else{
 ...
 *
 * @param urlQueryParameter the URL Key Value pair
 * @param httpUrlBuilder    HttpUrl Builder object
 */
private void addQueryParameter(Map<String, String> urlQueryParameter, HttpUrl.Builder httpUrlBuilder){
    if(urlQueryParameter != null && !urlQueryParameter.isEmpty()){
        for(Map.Entry<String, String> param : urlQueryParameter.entrySet()){
