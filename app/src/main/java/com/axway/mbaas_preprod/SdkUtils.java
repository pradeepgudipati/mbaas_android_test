...
public class SdkUtils {
    ...
    /**
     * In cases where the device API Level is below 5.0. (API Level - 21) - TLSv1.1 and TLSv1.2 protocols are not enabled by default. - SSLv3 protocol is not disabled by default. - SSLv3 is not a
     * secure protocol and it is therefore desirable to remove it from our client's list of supported protocols.
    ...
    /**
     * Checks if the current execution is on the UI thread
     *
     * @return true if on the Main UI Thread and false otherwise
     */
    ...
    /**
     * Returns the MIME type of the File at the path supplied in the parameter
     *
