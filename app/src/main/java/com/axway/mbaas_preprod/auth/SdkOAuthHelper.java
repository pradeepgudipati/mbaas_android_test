            ...
            public void onFetchConfigurationCompleted(@Nullable AuthorizationServiceConfiguration serviceConfiguration, @Nullable AuthorizationException ex) {
                ...
                if (ex != null) {
                    ...
                    try {
                        ...
                        TokenRequest formattedRequest = (new TokenRequest.Builder(serviceConfiguration, getSelectedIDP().getClientId())).setGrantType(grant_type).setScope(scopes).setClientId(
                                getSelectedIDP().getClientId()).setAdditionalParameters(additionalParameters).build();
